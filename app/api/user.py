...
def create_user(inputs: CreateUserRequest) -> Any:
    ...
    **username** should be unique to identify the user.
    It is a required field.\n
    **password** is a required field as well.\n
    **email** is optional for contact purposes.\n
    **full_name** is Optional.\n
    **disabled** field is a boolean (True or False).
    It tells if the user is disabled or not.
    It is Optional.\n
    **is_active** is a boolean and defaults to True.
    It is Optional.\n
    **is_superuser** is a boolean and defaults to False.
    It is Optional. \n
    """
...
async def login_for_access_token(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    **password** for the username is required\n
